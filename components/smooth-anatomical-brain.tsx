...
// Smoothed anatomical regions with organic geometries
...
type SmoothAnatomicalBrainProps = {
...
export function SmoothAnatomicalBrain({
  activeRegions,
  intensity = 0.5,
  showLabels = false,
  showPathways = true,
}: SmoothAnatomicalBrainProps) {
          ...
          >
            <mesh geometry={geometry}>
              <meshStandardMaterial
                color={region.color}
                transparent={true}
                opacity={isActive ? Math.min(0.9, region.baseOpacity + intensity * 0.3) : region.baseOpacity * 0.5}
